      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="text-center mb-10">
          ...
          <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
            Already submitted a report? <Link href="/report/status" className="font-medium text-indigo-600 hover:underline dark:text-indigo-400">Check your report status here.</Link>
          </p>
        </div>
        <ReportForm />
      </div>
