...
export default function TermsOfServicePage() {
  const filePath = path.join(process.cwd(), "app", "terms-of-service", "page.tsx")
        ...
        <div className="space-y-10">
          <section>
            <div className="flex items-start gap-3 mb-4">
              <FileText className="h-6 w-6 text-indigo-500 shrink-0 mt-1" />
          ...
          <section>
            <div className="flex items-start gap-3 mb-4">
              <Copyright className="h-6 w-6 text-indigo-500 shrink-0 mt-1" />
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white tracking-tight">
          ...
          <section>
            <div className="flex items-start gap-3 mb-4">
              <User className="h-6 w-6 text-indigo-500 shrink-0 mt-1" />
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white tracking-tight">
          ...
          <section>
            <div className="flex items-start gap-3 mb-4">
              <MessageSquare className="h-6 w-6 text-indigo-500 shrink-0 mt-1" />
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white tracking-tight">
          ...
          <section>
            <div className="flex items-start gap-3 mb-4">
              <AlertTriangle className="h-6 w-6 text-indigo-500 shrink-0 mt-1" />
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white tracking-tight">
          ...
          <section>
            <div className="flex items-start gap-3 mb-4">
              <Gavel className="h-6 w-6 text-indigo-500 shrink-0 mt-1" />
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white tracking-tight">
                7. Indemnification
              </h2>
            </div>
          ...
          <section>
            <div className="flex items-start gap-3 mb-4">
              <XCircle className="h-6 w-6 text-indigo-500 shrink-0 mt-1" />
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white tracking-tight">
                8. Termination
              </h2>
            </div>
          ...
          <section>
            <div className="flex items-start gap-3 mb-4">
              <Landmark className="h-6 w-6 text-indigo-500 shrink-0 mt-1" />
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white tracking-tight">
                9. Governing Law
              </h2>
            </div>
